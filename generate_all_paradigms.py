...
if __name__ == '__main__':
     ...
     protocols = ['InOut/Fino.g','InOut/P_K.g','InOut/Shen.g']
     timings = ['Pre','Post']
     paradigm_names = ['Fino','P_and_K','Shen']
     ...
     for timing in timings:
          for i, protocol in enumerate(protocols):
               ...
               sim_file = sim_name+'_'+timing+'_'+paradigm_names[i]+'_location_tertdend1_1_high_res.g'
               fil = open(sim_file,'w')
